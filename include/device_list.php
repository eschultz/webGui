...
function device_info($disk) {
  ...
  if ($display['spin']) {
    if ($var['fsState']=="Started") {
      ...
      $a_ = "<a href='update.htm?cmd={$cmd}' target='progressFrame'>"; $_a = "</a>";
  ...
  $optional_blinking_indicator = strpos($disk['color'],'off')===false ? "<img src='$blink' class='icon'>Disk spun-down<br>" : "";
  if ($type == 'Parity' || $type == 'Disk') {
    $status = "<a href='#' class='info' onClick='return false'><img src='$ball' class='$icon'><span>
               ...
               <img src='plugins/webGui/images/red-off.gif' class='icon'>Disabled, no disk present<br>
